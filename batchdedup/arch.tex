...
\begin{figure}
\centering
%\includegraphics[width=0.5\textwidth]{batch_arch}
%this is an alternate version of the figure done completely in latex
\input{figures/batch_arch}
...
\begin{figure}[th]
\centering
\includegraphics[width=0.5\textwidth]{Stage1}
...
\begin{figure}[th]
\centering
\includegraphics[width=0.5\textwidth]{Stage2}
...
\begin{figure}[th]
\centering
\includegraphics[width=0.5\textwidth]{Stage3}
...
\begin{figure}[th]
\centering
\includegraphics[width=0.5\textwidth]{Stage4}
