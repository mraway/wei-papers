  ...
  \centering
	\begin{tikzpicture}
		...
		%legend pos=north west
                ...
                \addplot table[x=rounds,y=throughput] {figures/sim_full.txt};
                %\legend{Total Backup Time};
		\end{axis}
	\end{tikzpicture}
  \caption{simulated results for average throughput for individual VMs in 100 node cluster.}
  \label{fig:mpibuf-mem}
\end{figure}
\begin{figure}[ht]
  \centering
	\begin{tikzpicture}
		...
		%title={Network Buffer Size},
		xlabel={Rounds},
		ylabel={Average Backup Time (min)},
		%extra y ticks={4.5,5.5,6.5} %to show extra ticks
		%legend pos=north west
		]
                \addplot table[x=rounds,y expr=(\thisrow{avgbackuptime})/60] {figures/sim_full.txt};
                %\legend{Total Backup Time};
		\end{axis}
	\end{tikzpicture}
  \caption{simulated results for average vm backup time for individual VMs in 100 node cluster.}
  \label{fig:mpibuf-mem}
\end{figure}
\begin{figure}[ht]
  \centering
	\begin{tikzpicture}
		...
		%title={Network Buffer Size},
		xlabel={Rounds},
		ylabel={Average Turnaround Time (min)},
		%extra y ticks={4.5,5.5,6.5} %to show extra ticks
		%legend pos=north west
		]
                \addplot table[x=rounds,y expr=(\thisrow{turnaround})/60] {figures/sim_full.txt};
                %\legend{Total Backup Time};
		\end{axis}
	\end{tikzpicture}
  \caption{simulated results for average vm turnaround time for individual VMs in 100 node cluster.}
  \label{fig:mpibuf-mem}
\end{figure}
...
\begin{figure}[ht]
  \centering
	\begin{tikzpicture}
		...
		%title={Network Buffer Size},
		xlabel={Rounds},
		ylabel={Total Jobspan (s)},
		%extra y ticks={4.5,5.5,6.5} %to show extra ticks
                %legend pos=north west
		]
                \addplot table[x=Rounds,y=DBP2jobspan] {figures/packing_comparison.txt};
                \addplot table[x=Rounds,y=BPLjobspan] {figures/packing_comparison.txt};
                \legend{DBP2, BPL};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[ht]
  \centering
	\begin{tikzpicture}
		...
		%title={Network Buffer Size},
		xlabel={Rounds},
		ylabel={Average Backup Time (s)},
		%extra y ticks={4.5,5.5,6.5} %to show extra ticks
                %legend pos=north west
		]
                \addplot table[x=Rounds,y=DBP2avgbackup] {figures/packing_comparison.txt};
                \addplot table[x=Rounds,y=BPLavgbackup] {figures/packing_comparison.txt};
                \legend{DBP2, BPL};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[ht]
  \centering
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
  \caption{Backup Cost for DBP2 and BPL}
  \label{fig:jobspan-comparison}
\end{figure}
