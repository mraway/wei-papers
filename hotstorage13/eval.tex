...
Level 1 segment dirty bits can identify 78\% of duplicate blocks. For the remaining dirty segments,
block-wise full cross-VM deduplication can remove about additional 70\% of duplicates.
Thus the content finally copied to the backup storage is reduced by 93.4\% in total.
...
The result shows the backup with multi-phase deduplication  for all VM images can be 
...
\hline Total Time  & N/A&  3.27 & 3.09 & 3.18 & 3.42 \\
  (Hours)           &  &   &  & &  \\
