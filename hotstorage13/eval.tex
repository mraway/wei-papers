...
The time in Stages 1 and 2  is  dominated by  the two scans of dirty VM segments
...
The system runs with  a single thread and  its CPU resource usage is upto 10\% of one core. 
