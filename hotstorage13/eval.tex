...
The average I/O usage of local storage is controlled about 50MB/second for our backup task
in the presence of other I/O jobs. Noted that a typical 1U server can host
6 to 8  hard drives and deliver over 300MB/second. Our setting uses 16.7\% or less of local storage bandwidth.
