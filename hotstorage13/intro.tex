...
accumulates detection requests and  then performs pre-detection   parititon by partition 
with minimal resource usage.
Fignureprint based partitioning allows highly parallel duplicate pre-detection  and also simplifies 
...
this pre-detecton scheme can provide  a sufficient throughput for large-scale cloud data  backup.   
