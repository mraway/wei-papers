...
Cloud providers often wish that the backup service only consumes  a small or modest resource usage 
with a minimal impact to the existing cloud services.  Another challenge for backup with deduplication is that deletion 
