...
and  the sufficient deduplication  throughput for dealing with a large number of virtual machine images. 
...
this multi-phase detection scheme can provide  a sufficient throughput for backup.   
