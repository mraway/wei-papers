...
\author{
Wei Zhang$^{\star}$, Tao Yang$^\star$, Gautham Narayanasamy$^\star$, Hong Tang$^\dagger$ \\
{\normalsize$^\star$Department of Computer Science, University of California at Santa Barbara}
