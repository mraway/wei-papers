...
\begin{figure*}[t]
    \centering
    \includegraphics[width=6in]{images/socc_arch_cluster.pdf}
    \caption{System Architecture}
    \label{fig:arch_cluster}
\end{figure*}
...
1G bytes. The reason we divide the snapshot into containers is to simplify the compact process
...
\begin{figure}[htbp]
  \centering
  \epsfig{file=images/sstore_arch.pdf, width=3in}
...
\begin{figure}[htbp]
  \centering
  \epsfig{file=images/pds_arch.pdf, width=3in}
