...
optimization of deduplication efficiency, and none of them have considered the impact
of deduplication for the fault tolerance in the cluster-based environment that we have considered
in this paper.
