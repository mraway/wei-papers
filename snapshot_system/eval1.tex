  ...
  %\includegraphics[scale=.45,natwidth=511,natheight=276]{vo_links}
	\begin{tikzpicture}
		...
		extra y ticks={99.99}, %if important numbers are missing
                ...
                \addplot table[x=NodesFailed,y=VO1]{figures/vm_availability_100000.txt};
                %\addlegendentry{$VO\,6.3$ (optimistic)}
                \addplot table[x=NodesFailed,y=VC1]{figures/vm_availability_100000.txt};
                %\addlegendentry{$VC\,1250$ (estimated)}
                \addplot table[x=NodesFailed,y=VC2]{figures/vm_availability_100000.txt};
