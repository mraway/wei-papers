  ...
  \centering
	\begin{tikzpicture}
		...
		%extra y ticks={4.5,5.5,6.5} %if important numbers are missing
                ...
                \addplot[color=blue,mark=square*] table[x=NodesFailed,y=VC2]{figures/cds_replication.txt};
                \addplot[color=blue,mark=triangle*,mark size=3] table[x=NodesFailed,y=VC3]{figures/cds_replication.txt};
                \addplot[color=blue,mark=diamond*,mark size=3] table[x=NodesFailed,y=VC4]{figures/cds_replication.txt};
