...
\comments{\begin{figure}[ht]
  ...
  %\includegraphics[scale=.45,natwidth=511,natheight=276]{vo_links}
	\begin{tikzpicture}
		...
		ylabel={\small chance that a VM is affected (\%) in VO},
		%extra y ticks={4.5,5.5,6.5} %because it only shows 4,5,6,7
		]
...
\comments{\begin{figure}[ht]
  ...
  %\includegraphics[scale=.45,natwidth=511,natheight=276]{vo_links}
	\begin{tikzpicture}
		...
		ylabel={\small Chance VM is affected (\%)},
...
\begin{figure}[ht]
  \centering
    \begin{tikzpicture}
            ...
            \addplot[color=blue,mark=none] table[x=NodesFailed,y=Availability5] {figures/fsb_availability.txt};
            \addplot[densely dashed, color=red,mark=none] table[x=NodesFailed,y=Availability4] {figures/fsb_availability.txt};
            \addplot[densely dotted,color=brown,mark=none] table[x=NodesFailed,y=Availability3] {figures/fsb_availability.txt};
            \legend{$R=5$,$R=4$,$R=3$};
            \end{axis}
    \end{tikzpicture}
  ...
  \centering
	\begin{tikzpicture}
		...
		extra y ticks={99.9}, %if important numbers are missing
                ...
                \addplot[color=blue,mark=*] table[x=NodesFailed,y=VC1]{figures/cds_replication2.txt};
                \addplot[color=red,mark=square*] table[x=NodesFailed,y=VC2]{figures/cds_replication2.txt};
                \addplot[color=brown,mark=triangle*,mark size=3] table[x=NodesFailed,y=VC3]{figures/cds_replication2.txt};
                %\addplot[color=black,mark=diamond*,mark size=3] table[x=NodesFailed,y=VC4]{figures/cds_replication2.txt};
                \legend{$R_C=3$,$R_C=4$,$R_C=5$}%,$R_C=7$}
		\end{axis}
	\end{tikzpicture}
