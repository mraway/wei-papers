  ...
  \centering
	\begin{tikzpicture}
		...
		legend pos=north west
                ...
                \addplot table[x=VMs,y=No] {figures/vo_vm_links_105.txt};
		\addplot table[x=VMs,y=N1] {figures/vc_vm_links_105.txt};
                \addplot+[red,densely dashed] table[x=VMs,y=N2] {figures/vc_vm_links_105.txt};
