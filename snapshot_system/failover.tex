...
The rate of increase in node failures can be seen in Figure~\ref{fig-vm-failue}.
The graph assumes 10X40GB snapshots per VM with 20\% unique data after local
