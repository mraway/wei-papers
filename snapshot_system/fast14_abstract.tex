...
localizes deduplication as much as possible within each virtual machine. Our approach uses similarity-guided
search and associate  underlying file blocks with one VM for most cases.
