...
For data modification during snapshot backup stage, a copy-on-write scheme is set so that backup
still copies a frozen version while the modification can still carry on.
