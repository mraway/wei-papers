...
%\begin{itemize}
%\item
There is also an independent store containing all PDS chunks shared among different VMs as
a single file.
...
This requires a scan of the entire snapshot store. Since it is a VM-specific procedure 
