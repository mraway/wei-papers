...
This step accomplishes the standard global fingerprint comparison using standard fingerprint 
comparison (e.g. ~\cite{bottleneck08}).
Our key observation is that the inner-VM deduplication has removed many of the duplicates.
...
This is not sufficient to enable effective prefetching which is required  for index sampling.
