...
That is one significant improvement compared to the work in ~\cite{WeiZhangIEEEClound}.
The reason is that  
%Without this (i.e. when we only check the parent segment at the same offset), 
