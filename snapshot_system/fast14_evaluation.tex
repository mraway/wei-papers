...
%in VM availability.
For example, with 5/100 machines failed, VO with 93.256\% availability would lose data in 169 VMs 
...
\begin{table}
  \centering
    \footnotesize
    \tabcolsep=0.11cm
    \comments{%table here is obsolete, now uses pgfpltostable to generate latex
        ...
        \multirow{3}{*}{Failures}   & \multicolumn{6}{c|}{Snapshot Availability} \\
                                    ...
                                    %\cline{2-7}
                                    & VO & VC & VC(Opt) & VO & VC & VC(Opt) \\
        \hline
        3 & 99.3042 & 99.7740 & 99.7740 & 99.9993 & 99.9998 & 99.9998 \\
        5 & 93.2561 & 97.7627  & 97.7627 & 99.9932 & 99.9978 & 99.9978 \\
        10 & 43.2519 & 76.0940 & 76.1541 & 99.9185 & 99.9736 & 99.9736 \\
        20 & 0.0340 & 5.6139 & 6.4942 & 99.2285 & 99.7490 & 99.7491 \\
        \hline
    \end{tabular}
    }
