...
%        \multirow{2}{c}{Nodes Failed & \multicolumn{2}{c}{p=100} & \multicolumn{2}{c}{p=1000} \\
%        1 & ~ & ~ & ~\\
%        5 & ~ & ~ & ~\\
%        10 & ~ & ~ & ~\\
%        20 & ~ & ~ & ~\\
...
Our VC approach delivers slightly worse deduplication efficiency compare to SRB, which is totally acceptable
because we are rewarded by architecture-wise benefits such as fault-tolerant and fast approximate deletion.
