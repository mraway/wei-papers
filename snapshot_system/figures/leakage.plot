...
plot "leakage.txt" using 1:2 ti 'Estimation {/Symbol D}u/u=0.025' w lp pt 6 lt 9 lw 6 lc 1, \
'' using 1:3 ti 'Measured {/Symbol D}u/u=0.025' w lp pt 7 lt 1 lw 6 lc 3, \
'' using 1:4 ti 'Measured {/Symbol D}u/u=0.05' w lp pt 5 lt 1 lw 6 lc 3, \
'' using 1:5 ti 'Measured {/Symbol D}u/u=0.10' w lp pt 9 lt 1 lw 6 lc 3