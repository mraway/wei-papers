...
Section~\ref{sect:framework}  discusses the  design options for snapshot backup with a VM-centric approach. 
Section~\ref{sect:model}  analyzes the benefit of our approach for fault isolation. 
