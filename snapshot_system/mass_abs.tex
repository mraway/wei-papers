...
cloud services.  This paper presents the design and implementation of
a low-profile VM-centric backup service with  a tradeoff 
...
This cluster-based service restricts global deduplication and 
separates popular chunks with non-popular ones.   
The  developed optimization includes similarity-guided local search 
for  the improved overall deduplication effectiveness 
and  VM-centric file system block management for the increased VM snapshot availability.  
