\subsection{Fault Tolerance and Snapshot Availability}
\label{sect:fault}
...
%\noindent 
\item
$r \le d<r_c$:  In this case there is no PDS data loss and we need to look at the non-PDS data loss. 
...
\item
%\noindent 
$r_c \leq d$: Both non-PDS and PDS file system blocks in VC can have a loss.
