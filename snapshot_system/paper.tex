...
\title{
VM-Centric  Snapshot Deduplication  for Converged Cloud Architectures} 
...
\terms{Design, Experimentation, Performance, Reliability}

\keywords{Virtual machine images, snapshot backup and deletion, source-side deduplication, 
cloud clusters and distributed architectures} % NOT required for Proceedings
