...
This VM-centric scheme also has  an advantage of   using less  computing resources, suitable for a collocated 
backup service on a non-dedicated cluster architecture.
