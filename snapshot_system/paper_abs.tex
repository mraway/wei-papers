...
intensive when the backup service is co-located with  other cloud services.
...
has  an advantage of   using less  computing resources, suitable for running
on a converged cloud architecture that cohosts  many other services.
This VM-centric scheme also leads to  better fault isolation and simplifies snapshot deletion.  
The key techniques used are to
