...
the number of non-PDS file blocks in VC is similar to the number of file blocks in VO.
Then
\[
...
\noindent {\bf $r \le d<r_c$:}  In this case there is no PDS data loss and we need to look at the non-PDS data loss. 
...
\noindent {\bf $r_c \leq d$:} Both non-PDS and PDS file system blocks in VC can have a loss.
