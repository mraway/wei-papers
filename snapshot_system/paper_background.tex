...
is clustered using a distributed file system (DFS)~\cite{googlefs03,hdfs10}.
...
A backup sevice runs on these commodity servers and stores deduplicated data  in  the storage in this cluster or in
...
Since the cluster we consider is shared by many cloud services,
...
We will consider the approximation techniques with reduced memory consumption. 
\end{itemize}
