...
$\sigma$ with a range of 1 to 4\% can deliver a fairly competitive deduplication efficiency. For example,
with top 2\% of the most popular chunks stored in PDS, nearly 40\% of the raw backup data can be eliminated
by fingerprint lookup in PDS index.
