...
accumnulate small local blocks. We manage  this accmulation process using an apendstore  scheme
...
we only store  top $k$ items and $k$ is  chosen to be small while 
