...
\begin{figure}
  \centering
  \epsfig{file=images/overall_effect.eps, width=2.8in}
...
\begin{figure}
\centering
\epsfig{file=images/ay41a_big.data_disk.cdf.eps, width=2.8in}
...
\begin{figure}
  \centering
  \epsfig{file=images/uniquedata-saving.eps, width=2.8in}
...
\begin{figure}
  \centering
  \epsfig{file=images/cds_scale.0.7.eps, width=2.8in}
